...
public class SoundRepo : MonoBehaviour
{
    ...
    private static readonly List<Sound> availableSounds = new List<Sound>{
        ...
        new Sound(SoundType.HEART, "Heart - Diastolic Rumble"),
        new Sound(SoundType.HEART, "Heart - Early Systolic Murmur"),
        new Sound(SoundType.HEART, "Heart - Ejection Click"),
        new Sound(SoundType.HEART, "Heart - Opening Snap"),
        new Sound(SoundType.HEART, "Heart - Pansystolic Murmur"),
        new Sound(SoundType.HEART, "Heart - S3"),
        new Sound(SoundType.HEART, "Heart - Normal Split S1"),
        new Sound(SoundType.HEART, "Heart - Normal Split Second Sound"),
        new Sound(SoundType.HEART, "Heart - S4"),
        new Sound(SoundType.LUNG, "Lung - Normal Vesicular"),
        new Sound(SoundType.LUNG, "Lung - Wheezing"),
        new Sound(SoundType.LUNG, "Lung - Pleural Friction"),
        new Sound(SoundType.LUNG, "Lung - Inspiratory Stridor"),
        new Sound(SoundType.LUNG, "Lung - Coarse Crackles"),
        ...
        new Sound(SoundType.AMBIENT, "EmergencyRoomBackgroundNoise"),
